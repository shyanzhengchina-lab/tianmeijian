...
// ─── Mock MRB 数据（基于不合格检验任务生成）─────────────────────────────────

const initMrbRecords = (): MrbRecord[] => [
  {
    id: 'MRB001',
    mrbNo: 'MRB-20260423-001',
    taskId: 'IT007',
    ...
    reviewerName: '张伟',
    decision: 'SCRAP',
    decisionRemark: '硬度超标（392HV，标准300~380HV），全批退货处理，通知供应商整改',
    reviewTime: '2026-04-23 11:00:00',
    capaNo: 'CAPA-2604-001',
    createdAt: '2026-04-23 10:30:00',
  },
  {
    id: 'MRB002',
    mrbNo: 'MRB-20260426-002',
    taskId: 'IT004',
