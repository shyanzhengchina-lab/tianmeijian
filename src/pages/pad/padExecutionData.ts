...
// ！！与 workOrderData.ts mockWorkOrders WO001~WO005 严格对齐，id/woNo/batchNo 完全一致
// 生产订单页显示的批次必须在此列表中找到对应工单，才能在批记录打印页生成EBR

export const MOCK_WORK_ORDERS: WorkOrder[] = [
  // WO001 — 维生素C咀嚼片 500mg×60粒/瓶（已完成，MO-20260601-001）
  {
    id:            'WO001',
    ...
    materialCode:  'FG-VITC-500MG-AP',
    materialName:  '维生素C咀嚼片（500mg铝塑）',
    currentOpSeq:  10,
  },
  ...
  // WO003 — 维生素C咀嚼片 250mg×100粒/瓶（已下发，MO-20260610-001）
  {
    ...
    materialCode:  'FG-VITC-250MG-BTL',
    materialName:  '维生素C咀嚼片（250mg瓶装）',
    currentOpSeq:  10,
  },
