...
const EQUIP_TYPE_OPTIONS = [
  { group: '加工设备',   items: ['数控五轴磨床', '数控四轴磨床', 'CNC加工中心', '车铣复合中心'] },
  { group: '热处理设备', items: ['镍钛丝热处理炉', '真空热处理炉', '盐浴炉'] },
  { group: '涂层设备',   items: ['PVD镀膜机', 'CVD沉积设备', 'DLC涂层机'] },
  { group: '标识设备',   items: ['光纤激光打标机', 'CO₂激光打标机', '喷码机'] },
  { group: '清洗设备',   items: ['超声波清洗机', '高压水枪清洗机', '真空清洗机'] },
  { group: '检验设备',   items: ['投影仪（万能工具显微镜）', '三坐标测量机', '扭转试验机', '疲劳试验机', '维氏硬度计', '表面粗糙度仪'] },
  { group: '包装/灭菌',  items: ['全自动热封机', 'EO灭菌柜', '辐照灭菌设备', '自动装箱机'] },
];
